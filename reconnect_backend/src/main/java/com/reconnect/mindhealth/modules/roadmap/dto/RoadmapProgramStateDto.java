...
public class RoadmapProgramStateDto {
    ...
    private List<PatientQuestDto> todayAssignments = new ArrayList<>();
    ...
    public String getNextRecommendedIntervention() {
        return nextRecommendedIntervention;
    }
    ...
    public void setNextRerateAt(LocalDateTime nextRerateAt) {
        this.nextRerateAt = nextRerateAt;
    }

    public List<RoadmapProgramModuleDto> getUnlockedModules() {
        return unlockedModules;
    }

    public void setUnlockedModules(List<RoadmapProgramModuleDto> unlockedModules) {
        this.unlockedModules = unlockedModules;
    }

    public List<RoadmapProgramModuleDto> getLockedModules() {
        return lockedModules;
    }

    public void setLockedModules(List<RoadmapProgramModuleDto> lockedModules) {
        this.lockedModules = lockedModules;
    }

    public List<PatientQuestDto> getTodayAssignments() {
        return todayAssignments;
    }

    public void setTodayAssignments(List<PatientQuestDto> todayAssignments) {
