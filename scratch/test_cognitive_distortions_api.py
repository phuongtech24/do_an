...
def main():
    parser = argparse.ArgumentParser(description="Smoke test: Cognitive Distortions (AI) API.")
    parser.add_argument("--base-url", default="http://localhost:8081/api")
    args = parser.parse_args()

    base = args.base_url.rstrip("/")
    url = f"{base}/ai/cognitive-distortions"
    payload = {
        "situation": "Mình sắp thuyết trình trước lớp.",
        "automaticThought": "Chắc chắn mình sẽ làm hỏng và mọi người sẽ coi thường mình.",
    }
